...
public class ChartsController {
    ...
    @RequestMapping(value = "/charts/google_chart_scatter", method = RequestMethod.GET)  
    ...
    @RequestMapping(value = "/charts/google_chart", method = RequestMethod.GET)  
    public ModelAndView edit2(ModelAndView modelAndView) {
    modelAndView.setViewName("charts/google_chart");
    ArrayList datas = new ArrayList();
        // ['Age', 'Weight'],[8, 12],[4, 5.5],[11, 14],[4, 5],[3, 3.5],[6.5, 7];
        datas.add(Arrays.asList("Age", "Weight"));
        datas.add(Arrays.asList(8, 12));
